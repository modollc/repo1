...
import com.djk.web.service.dige.DigeDiningService;

import com.djk.web.util.ResultMap;

@Controller
@RequestMapping("/dige/digeDining/")
public class DigeDiningController {

	@Autowired
	private DigeDiningService digeSceneService;

	
	@RequestMapping(value = "index", method = { RequestMethod.GET })
	public String index(Map<String, Object> dataMap, HttpServletRequest request) throws Exception {
		return "dige/dining/dining";
	}
	...
	public Object list(Map<String, Object> dataMap, HttpServletRequest request) throws Exception {
		DigeDining foodSupplier=new DigeDining();
		foodSupplier.setMealQuantity(request.getParameter("searchValue"));
		PageInfoBT<DigeDining> findPage = digeSceneService.findPage(foodSupplier);
		return findPage;
	}
	...
	public String edit(Map<String, Object> dataMap, HttpServletRequest request,Integer id) throws Exception {
		DigeDining foodSupplier = digeSceneService.get(id);
		dataMap.put("foodSupplier", foodSupplier);
		return "dige/dining/edit";
	}
	...
	@ResponseBody
	public ResultMap delete(HttpServletRequest request, DigeDining foodSupplier) {
	...
	@ResponseBody
	public ResultMap save(HttpServletRequest request, DigeDining foodSupplier) {
    ...
    @ResponseBody
    public int checkNameUnique(DigeDining digeDining)
    {
        int uniqueFlag = 0;
        if (digeDining != null)
        {
             Integer id = digeDining.getId();
             DigeDining info = digeSceneService.checkNameUnique(digeDining.getMealQuantity());
