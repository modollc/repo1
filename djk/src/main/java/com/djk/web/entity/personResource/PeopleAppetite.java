...
/**
 * 人需公共资源-食欲状态
 * <p>Table: <strong>people_appetite</strong>
 ...
 *   <tr><td>appetiteName</td><td>{@link java.lang.String}</td><td>appetite_name</td><td>varchar</td><td>名称</td></tr>
 *   <tr><td>appetiteValue</td><td>{@link java.math.BigDecimal}</td><td>appetite_value</td><td>decimal</td><td>系数</td></tr>
 *   <tr><td>delFlag</td><td>{@link java.lang.String}</td><td>del_flag</td><td>char</td><td>删除标识  1、未删除 2、已删除</td></tr>
 * </table>
 *
 */
public class PeopleAppetite extends DataModel<PeopleAppetite> {
 
 	private java.lang.String appetiteName;
 	private java.math.BigDecimal appetiteValue;
 		
	/**
     * 获取名称
     */
	public java.lang.String getAppetiteName(){
		return this.appetiteName;
	}
 		
	/**
     * 设置名称
     */
	public void setAppetiteName(java.lang.String appetiteName){
     ...
     * 获取系数
     */
	public java.math.BigDecimal getAppetiteValue(){
		return this.appetiteValue;
	}
 		
	/**
     * 设置系数
     */
	public void setAppetiteValue(java.math.BigDecimal appetiteValue){
