...
public class WebUtil {
	...
	public static PagerInfo handlerPagerInfo(HttpServletRequest request, Object map) {
		try {
			int pageSize = "".equals(StringUtil.nullSafeString(request.getParameter("rows"))) ? ConstantsEJS.DEFAULT_PAGE_SIZE_10 : Integer.parseInt(request.getParameter("rows"));
			int pageIndex = "".equals(StringUtil.nullSafeString(request.getParameter("page"))) ? 1 : Integer.parseInt(request.getParameter("page"));
			...
			return new PagerInfo(pageSize, pageIndex, url, queryString);
	...
	public static PagerInfo handlerPagerInfo(HttpServletRequest request, Object map, int pageSize) {
		try {
			if (pageSize == 0) {
				pageSize = "".equals(StringUtil.nullSafeString(request.getParameter("rows"))) ? ConstantsEJS.DEFAULT_PAGE_SIZE : Integer.parseInt(request.getParameter("rows"));
			}
			int pageIndex = "".equals(StringUtil.nullSafeString(request.getParameter("page"))) ? 1 : Integer.parseInt(request.getParameter("page"));
	...
	public static PaginationUtil handlerPaginationUtil(HttpServletRequest request) {
		...
		if (request.getAttribute("pageSize") != null) {
			pageSize = "".equals(StringUtil.nullSafeString(request.getAttribute("pageSize").toString())) ? 1 : Integer.parseInt(request.getAttribute("pageSize").toString());
		}
