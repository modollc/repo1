...
public class ConstantsEJS {
    ...
    public final static String NAMESPACE_MOBILEMALL_WEB_MEMBER         = "doubang:b2b2c:web:member";
    ...
    /**
     * 和拍卖商城的变量同步，存放拍卖商家上传图片内容，以auction_seller/商家ID
     */
    public final static String AUCTION_SELLER_ID                               = "auction_seller_id";
    /**
    ...
    /**
     * 和商城的变量同步，存放会员上传图片内容，以member/会员ID
     */
