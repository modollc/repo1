...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodPhyState.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">物理状态：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="foodStatus" id="foodStatus"  value="${foodPhyState.foodStatus }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="foodValue" id="foodValue"  value="${foodPhyState.foodValue }">
				</div>
			</div>
	...
	<script src="../../static/main/system/post/edit.js" >
	</script>
</body>
</html>
