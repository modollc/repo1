...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="cookingMethod" id="cookingMethod" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="cookingValue" id="cookingValue" >
				</div>
			</div>
	...
	<script src="../../../static/main/system/cooking/add.js" >
	</script>
</body>
</html>
