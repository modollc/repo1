...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">烹饪方式：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="cookingMethod" id="cookingMethod" value="${foodSupplier.cookingMethod }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="cookingValue" id="cookingValue" value="${foodSupplier.cookingValue }">
				</div>
			</div>
	...
	<script src="../../../static/main/system/cooking/edit.js" >
	</script>
</body>
</html>
