...
<jsp:include page="../head_js_css.jsp" />
                    ...
                    <div class="zTreeDemoBackground">
                        <ul class="list">
                            ...
                            <li>
                                ...
                                <input class="uk-input uk-form-width-medium" type="text" name="name" value="${food.name}">
                            ...
                            <li>
                                ...
                                <input class="uk-input uk-form-width-medium citySel in1" onclick="showMenu(1);" type="text" name="firstCategoryName"  value="${food.firstCategoryName}">
                            ...
                            <li>
                                ...
                                <div class="jldw">
                                    <input class="uk-input" type="text" name="unitNum" value="${food.unitNum}">
                            ...
                            <tbody>
                             	<c:forEach items="${foodNutritionComponentList}" var="item">
	                                <tr>
	                                    ...
	                                    <td><input class="uk-input uk-form-blank uk-form-width-medium" type="text" placeholder="" name="nutritionValue" value="${item.nutritionComponentNum}">
	                                    </td>
	                                </tr>
						        </c:forEach>
                            </tbody>
