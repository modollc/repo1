...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="supplierName" id="supplierName" value="${foodSupplier.supplierName }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">品牌：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="supplierBrand" id="supplierBrand" value="${foodSupplier.supplierBrand }" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="supplierValue" id="supplierValue" value="${foodSupplier.supplierValue }">
				</div>
			</div>
	...
	<script src="../../../static/main/system/supplier/edit.js" >
	</script>
</body>
</html>
