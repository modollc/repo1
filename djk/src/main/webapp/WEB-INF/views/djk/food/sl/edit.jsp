...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSeasonal.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">物理状态：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="seasonal" id="seasonal"  value="${foodSeasonal.seasonal }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="seasonalValue" id="seasonalValue"  value="${foodSeasonal.seasonalValue }">
				</div>
			</div>
	...
	<script src="../../../static/main/system/sl/edit.js" >
	</script>
</body>
</html>
