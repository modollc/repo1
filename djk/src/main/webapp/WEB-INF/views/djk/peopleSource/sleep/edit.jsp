...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleSleep.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">睡眠量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepQuality" id="sleepQuality" value="${peopleSleep.sleepQuality}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">范围：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepTime" id="sleepTime" value="${peopleSleep.sleepTime}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepValue" id="sleepValue" value="${peopleSleep.sleepValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleSleep/edit.js" >
	</script>
</body>
</html>
