...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleMovement.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementName" id="movementName" value="${peopleMovement.movementName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">时长：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementTime" id="movementTime" value="${peopleMovement.movementTime}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementNum" id="movementNum" value="${peopleMovement.movementNum}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleMovement/edit.js" >
	</script>
</body>
</html>
