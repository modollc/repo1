...
.navMenu-item:nth-child(5) .navMenu-item-content li:nth-child(4) a{
    color: #622f00;
   font-weight: bold;
}
</style>
...
<script src="../../../static/main/peopleResouce/peopleAppetite/appetite.js"></script>	
