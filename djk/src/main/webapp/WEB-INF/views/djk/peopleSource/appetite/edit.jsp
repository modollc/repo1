...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleAppetite.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="appetiteName" id="appetiteName" value="${peopleAppetite.appetiteName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="appetiteValue" id="appetiteValue" value="${peopleAppetite.appetiteValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleAppetite/edit.js" >
	</script>
</body>
</html>
