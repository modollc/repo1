...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementName" id="movementName"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">时长：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementTime" id="movementTime"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">消耗能量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="movementNum" id="movementNum">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleMovement/add.js" >
	</script>
</body>
</html>
