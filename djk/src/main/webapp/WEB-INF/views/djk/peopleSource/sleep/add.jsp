...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				<label class="col-sm-3 control-label ">睡眠质量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepQuality" id="sleepQuality"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">时长(h)：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepTime" id="sleepTime"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sleepValue" id="sleepValue">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleSleep/add.js" >
	</script>
</body>
</html>
