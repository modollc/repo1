...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleArea.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">人均面积(㎡)</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="area" id="area" value="${peopleArea.area}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="areaValue" id="areaValue" value="${peopleArea.areaValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleArea/edit.js" >
	</script>
</body>
</html>
