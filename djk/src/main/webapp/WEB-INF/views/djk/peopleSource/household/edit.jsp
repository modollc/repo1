...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleHousehold.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">家居人口：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="household" id="household" value="${peopleHousehold.household}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="householdValue" id="householdValue" value="${peopleHousehold.householdValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleHousehold/edit.js" >
	</script>
</body>
</html>
