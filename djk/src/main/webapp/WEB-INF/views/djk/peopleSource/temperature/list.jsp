...
<style>
.navMenu-item:nth-child(5) .navMenu-title {
     background: #c38447;
    color: #fff;
}
.navMenu-item:nth-child(5) .navMenu-item-content li:nth-child(5) a{
   color: #622f00;
   font-weight: bold;
}
</style>
...
<script src="../../../static/main/peopleResouce/peopleTemperature/temperature.js"></script>	
