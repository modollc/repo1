...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleActive.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="activeName" id="activeName" value="${peopleActive.activeName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="activeValue" id="activeValue" value="${peopleActive.activeValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleActive/edit.js" >
	</script>
</body>
</html>
