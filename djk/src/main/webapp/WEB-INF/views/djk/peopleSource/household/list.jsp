...
.navMenu-item:nth-child(5) .navMenu-item-content li:nth-child(6) a{
    color: #622f00;
   font-weight: bold;
}
</style>
...
<script src="../../../static/main/peopleResouce/peopleHousehold/household.js"></script>	
