...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${peopleTemperature.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">范围：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="temperature" id="temperature" value="${peopleTemperature.temperature}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="temperatureValue" id="temperatureValue" value="${peopleTemperature.temperatureValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/peopleResouce/peopleTemperature/edit.js" >
	</script>
</body>
</html>
