...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
		    <input class="form-control" type="hidden" name="nutritionCategoryId" id="nutritionCategoryId" value="${fId }" />
		    <input class="form-control" type="hidden" name="pids" id="pids" value="${pids }" />
			
			<div class="form-group">
				<label class="col-sm-3 control-label ">营养分类：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionCategoryName" readOnly id="nutritionCategoryName" value="${fName }"/>
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../static/main/system/newnutrition/add.js" >
	</script>
</body>
</html>
