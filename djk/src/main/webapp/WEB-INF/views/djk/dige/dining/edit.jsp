...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">用餐量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="mealQuantity" id="mealQuantity" value="${foodSupplier.mealQuantity }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">范围：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="mealScope" id="mealScope" value="${foodSupplier.mealScope }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="mealValue" id="mealValue" value="${foodSupplier.mealValue }"、>
				</div>
			</div>
	...
	<script src="../../../static/main/system/dining/edit.js" >
	</script>
</body>
</html>
