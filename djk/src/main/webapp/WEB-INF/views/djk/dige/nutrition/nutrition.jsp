...
<style>
.navMenu-item:nth-child(3) .navMenu-title {
    background: #c38447;
    color: #fff;
}
.navMenu-item:nth-child(3) .navMenu-item-content li:nth-child(4) a{
   color: #622f00;
   font-weight: bold;
}
</style>
...
<script src="../../../static/main/system/nutrition/nutrition.js"></script>	
