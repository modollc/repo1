...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionQuantity" id="nutritionQuantity"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">数值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionNumber" id="nutritionNumber"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionValue" id="nutritionValue">
				</div>
			</div>
	...
	<script src="../../../static/main/system/nutrition/add.js" >
	</script>
</body>
</html>
