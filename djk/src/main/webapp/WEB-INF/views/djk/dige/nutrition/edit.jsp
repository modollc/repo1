...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
				...
				<label class="col-sm-3 control-label ">营养需要量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionQuantity" id="nutritionQuantity" value="${foodSupplier.nutritionQuantity }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">数值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionNumber" id="nutritionNumber" value="${foodSupplier.nutritionNumber }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="nutritionValue" id="nutritionValue" value="${foodSupplier.nutritionValue }"/>
				</div>
			</div>
	...
	<script src="../../../static/main/system/nutrition/edit.js" >
	</script>
</body>
</html>
