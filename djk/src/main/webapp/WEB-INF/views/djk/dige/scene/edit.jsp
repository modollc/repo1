...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">场景名：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sceneName" id="sceneName" value="${foodSupplier.sceneName }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">参考值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="reference" id="reference" value="${foodSupplier.reference }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sceneValue" id="sceneValue" value="${foodSupplier.sceneValue }" >
				</div>
			</div>
	...
	<script src="../../../static/main/system/scene/edit.js" >
	</script>
</body>
</html>
