...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${foodSupplier.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">吃饭速度：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="eatFast" id="eatFast" value="${foodSupplier.eatFast }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">参考值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="eatTime" id="eatTime" value="${foodSupplier.eatTime }"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="eatValue" id="eatValue" value="${foodSupplier.eatValue }"/>
				</div>
			</div>
	...
	<script src="../../../static/main/system/eatfast/edit.js" >
	</script>
</body>
</html>
