...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemConstant.id }"/>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="constantName" id="constantName" value="${systemConstant.constantName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">最大值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="maxValue" id="maxValue" value="${systemConstant.maxValue}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">最小值：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="minValue" id="minValue" value="${systemConstant.minValue}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">增幅：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="constantValue" id="constantValue" value="${systemConstant.constantValue}">
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../../../static/main/systemResource/constant/baseConstant/edit.js" >
	</script>
</body>
</html>
