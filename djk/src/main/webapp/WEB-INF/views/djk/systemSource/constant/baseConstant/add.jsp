...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="constantName" id="constantName">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="constantValue" id="constantValue">
				</div>
			</div>
	...
	<script src="../../../../static/main/systemResource/constant/baseConstant/add.js" >
	</script>
</body>
</html>
