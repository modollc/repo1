...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitName" id="unitName">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitNum" id="unitNum">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">换算(mm³)：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitValue" id="unitValue">
				</div>
			</div>
	...
	<script src="../../../static/main/systemResource/unit/add.js" >
	</script>
</body>
</html>
