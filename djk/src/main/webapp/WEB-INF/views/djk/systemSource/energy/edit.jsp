...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemEnergy.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">单位名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyName" id="energyName" value="${systemEnergy.energyName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyNum" id="energyNum" value="${systemEnergy.energyNum}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyValue" id="energyValue" value="${systemEnergy.energyValue}">
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../../static/main/systemResource/energy/edit.js" >
	</script>
</body>
</html>
