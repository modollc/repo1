...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemConstantSex.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">性别名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="sexName" id="sexName" value="${systemConstantSex.sexName}">
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../../../static/main/systemResource/constant/sexConstant/edit.js" >
	</script>
</body>
</html>
