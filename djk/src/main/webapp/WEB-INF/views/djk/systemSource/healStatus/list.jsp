...
.navMenu-item:nth-child(6) .navMenu-item-content li:nth-child(2) a{
    color: #622f00;
   font-weight: bold;
}
</style>
...
<script src="../../../static/main/systemResource/healStatus/healStatus.js"></script>	
