...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemWeight.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">单位名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightName" id="weightName" value="${systemWeight.weightName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightNum" id="weightNum" value="${systemWeight.weightNum}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">换算：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightValue" id="weightValue" value="${systemWeight.weightValue}">
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../../static/main/systemResource/weight/edit.js" >
	</script>
</body>
</html>
