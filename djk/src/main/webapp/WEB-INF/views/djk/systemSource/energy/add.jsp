...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyName" id="energyName">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyNum" id="energyNum">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="energyValue" id="energyValue">
				</div>
			</div>
	...
	<script src="../../../static/main/systemResource/energy/add.js" >
	</script>
</body>
</html>
