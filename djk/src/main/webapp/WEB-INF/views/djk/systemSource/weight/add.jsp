...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-post-add">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightName" id="weightName">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightNum" id="weightNum">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">换算：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="weightValue" id="weightValue">
				</div>
			</div>
	...
	<script src="../../../static/main/systemResource/weight/add.js" >
	</script>
</body>
</html>
