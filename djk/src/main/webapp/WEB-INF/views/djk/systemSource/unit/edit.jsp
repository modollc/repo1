...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemUnit.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">单位名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitName" id="unitName" value="${systemUnit.unitName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label ">数量：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitNum" id="unitNum" value="${systemUnit.unitNum}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">换算(mm³)：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="unitValue" id="unitValue" value="${systemUnit.unitValue}">
				</div>
			</div>
			<div class="form-group">
	...
	<script src="../../../static/main/systemResource/unit/edit.js" >
	</script>
</body>
</html>
