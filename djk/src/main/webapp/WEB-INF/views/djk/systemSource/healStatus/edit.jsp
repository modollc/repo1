...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		...
		<input class="form-control" type="hidden" name="id" id="id" value="${systemHealth.id }"/>
			<div class="form-group">
				<label class="col-sm-3 control-label ">人均面积(㎡)</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="healthName" id="healthName" value="${systemHealth.healthName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">系数：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="healthValue" id="healthValue" value="${systemHealth.healthValue}">
				</div>
			</div>
	...
	<script src="../../../static/main/systemResource/healStatus/edit.js" >
	</script>
</body>
</html>
